...
class _CustomWebviewPageState extends State<CustomWebviewPage> {
  ...
  InAppWebViewSettings options = InAppWebViewSettings(
    ...
    userAgent: "Mozilla/5.0 (Linux; Android 14; Pixel 8 Pro) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/138.0.0.0 Mobile Safari/537.36"
  );
  ...
  setupCustomEventListener(
    ...
    controller.addJavaScriptHandler(
      ...
      callback: (args) {
        ...
        final launchMode = launchUri != null && !['http', 'https', 'file', 'chrome', 'data', 'javascript', 'about'].contains(launchUri.scheme.toLowerCase())
