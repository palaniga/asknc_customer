...
import 'package:Asknc_user/views/pages/order/widgets/taxi_order_trip_verification.view.dart';
import 'package:Asknc_user/views/pages/taxi/widgets/driver_info.view.dart';
import 'package:Asknc_user/views/pages/taxi/widgets/safety.view.dart';
        ...
        return MeasureSize(
          onChange: (size) {
            vm.updateGoogleMapPadding(
                height: 320, driverInfo: vm.onGoingOrderTrip!.driver!);
          },
          child: VStack(
            [
              //driver info
