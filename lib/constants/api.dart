...
class Api {
  static String get baseUrl {
    // return "https://www.asknc.digitaltriumph.co.in/api";
    // // return "https://Asknc_user.edentech.online/api";
    // return "https://www.dev.asknc.in/api";
    return "https://www.portal.asknc.in/api";
  }
  ...
  static String get returnPolicy {
    final webUrl = baseUrl.replaceAll('/api', '');
    return "$webUrl/cms/refund-policy";
  }
