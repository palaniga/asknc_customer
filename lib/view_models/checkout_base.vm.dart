...
import 'package:Asknc_user/services/checkout.service.dart';
...
class CheckoutBaseViewModel extends PaymentViewModel {
  ...
  updateTotalOrderSummary() async {
    ...
    //tax
    checkout!.tax =
        (double.parse(vendor!.tax) / 100) * checkout!.subTotal.round();
  ...
  processOrderPlacement() async {
    ...
    if (apiResponse.allGood) {
      ...
      if (!paymentLink.isEmptyOrNull) {
        // Safely pop the current page if there's something to pop
