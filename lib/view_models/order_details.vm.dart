...
import 'package:Asknc_user/requests/order.request.dart';
import 'package:Asknc_user/services/app.service.dart';
import 'package:Asknc_user/services/chat.service.dart';
...
import 'package:Asknc_user/widgets/bottomsheets/driver_rating.bottomsheet.dart';
import 'package:Asknc_user/widgets/bottomsheets/order_cancellation.bottomsheet.dart';
import 'package:Asknc_user/widgets/bottomsheets/vendor_rating.bottomsheet.dart';
    ...
    await Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => DriverRatingBottomSheet(
          order: order,
          onSubmitted: () {
            Navigator.pop(context); // Close the bottom sheet/page
            fetchOrderDetails(); // Refresh order info
          },
        ),
      ),
    );
