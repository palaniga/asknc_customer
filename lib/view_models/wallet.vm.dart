...
import 'package:Asknc_user/models/wallet.dart';
import 'package:Asknc_user/models/wallet_transaction.dart';
import 'package:Asknc_user/requests/wallet.request.dart';
import 'package:Asknc_user/services/app.service.dart';
import 'package:Asknc_user/view_models/payment.view_model.dart';
import 'package:Asknc_user/views/pages/wallet/wallet_transfer.page.dart';
import 'package:Asknc_user/widgets/bottomsheets/wallet_amount_entry.bottomsheet.dart';
import 'package:Asknc_user/widgets/finance/wallet_address.bottom_sheet.dart';
...
class WalletViewModel extends PaymentViewModel {
  ...
  initiateWalletTopUp(String amount) async {
    ...
    try {
      ...
      await openWebpageLink(link, embeded: false);
      clearErrors();
    } catch (error) {
      setError(error);
      toastError("$error");
