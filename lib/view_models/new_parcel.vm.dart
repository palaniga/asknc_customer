...
import 'package:Asknc_user/models/order_stop.dart';
import 'package:Asknc_user/models/package_checkout.dart';
import 'package:Asknc_user/models/package_type.dart';
...
import 'package:Asknc_user/requests/checkout.request.dart';
import 'package:Asknc_user/requests/delivery_address.request.dart';
import 'package:Asknc_user/requests/package.request.dart';
...
import 'package:Asknc_user/widgets/bottomsheets/parcel_location_picker_option.bottomsheet.dart';
...
class NewParcelViewModel extends PaymentViewModel {
  ...
  Future fetchParcelVendors() async {
    //
    vendors = [];
    selectedVendor = null;
