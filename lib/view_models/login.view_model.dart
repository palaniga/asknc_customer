...
import 'package:Asknc_user/services/social_media_login.service.dart';
import 'package:Asknc_user/traits/qrcode_scanner.trait.dart';
...
import 'package:Asknc_user/widgets/bottomsheets/account_verification_entry.dart';
...
class LoginViewModel extends MyBaseViewModel with QrcodeScannerTrait {
  ...
  void initialise() async {
    ...
    try {
      ...
      this.selectedCountry = Country.parse("in");
    }
  }
  ...
  processFirebaseOTPVerification() async {
    ...
    await FirebaseAuth.instance.verifyPhoneNumber(
      ...
      codeSent: (String verificationId, int? resendToken) async {
        ...
        showVerificationEntry(viewContext);
      },
  ...
  //
  void showVerificationEntry(BuildContext context) async {
    //
    setBusy(false);
    //
    await Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => AccountVerificationEntry(
          ...
          onResendCode: () async {
            if (!AppStrings.isCustomOtp) return;
